...
```bash
docker run -d --name vdexnode --network volentix -e "IP=35.203.51.175" -e "EOSKEY=Your_Public_Key_Here" -p 8000:8000 -p 4222:4222/udp volentix/vdexnode:latest server
```
