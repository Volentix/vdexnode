...
exec nodeos -e -p eosio --disable-replay-opts --delete-all-blocks --contracts-console  --verbose-http-errors 2> /dev/pts/2 
# sleep 4
...
# sleep 10
# docker run -id -p 8545:8545 -p 8546:8546 -p 30303:30303 -p 30303:30303/udp openethereum/openethereum:v3.0.0 --jsonrpc-interface all >&/dev/pts/2 &
# cd ../oracle
# rm -rf node_modules
# rm package.json
...
# cleos push action volentixvote voteproducer  '{"voter_name": "v11111111111", "producers":["v22222222222"]}' -p v11111111111@active 
# cleos push action
# node ../oracle/oracle_test_sep30.js&
# echo "sleeping"
# sleep 20
# killall node
