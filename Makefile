...
CTAGS = ctags
CSCOPE = cscope
DIST_SUBDIRS = src tools python tests doc
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.h.in \
	$(srcdir)/opendht.pc.in $(top_srcdir)/ac/ar-lib \
	$(top_srcdir)/ac/compile $(top_srcdir)/ac/config.guess \
	$(top_srcdir)/ac/config.sub $(top_srcdir)/ac/install-sh \
	$(top_srcdir)/ac/ltmain.sh $(top_srcdir)/ac/missing COPYING \
...
VERSION = 1.9.4
WINDOWS_ARCH = 
abs_builddir = /home/sylvain/vDexNetwork/vDexNode
abs_srcdir = /home/sylvain/vDexNetwork/vDexNode
...
opendht.pc: $(top_builddir)/config.status $(srcdir)/opendht.pc.in
