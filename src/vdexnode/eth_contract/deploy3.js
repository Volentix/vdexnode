...
const input = fs.readFileSync('./contracts/VTXToken.sol');
const output = solc.compile(input.toString(), 1);
const bytecode = output.contracts['VTXToken'].bytecode;
const abi = JSON.parse(output.contracts['VTXToken'].interface);
