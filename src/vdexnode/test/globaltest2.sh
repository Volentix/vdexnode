...
i#ID=$(curl -s http://127.0.0.1:8000/ | jq '.id')
...
#cleos --url  http://140.82.56.143:8888 create account  eosio vltxstakenow EOS6c9WQnuT2WT6sPhZqRnqEVZSbf1kCKarpCo6eZpfMG5Z2dtm2R EOS8UDRf4xaFz7qRXTnSE8W5AeVDHcAHe5iMwozTJTLEqSuz6ca6z
echo "|____________________________________________________________________________________________________________________________________________|"
...
cleos --url  http://140.82.56.143:8888 set contract vltxstakenow ../contracts/volentixstak/ volentixstak.wasm volentixstak.abi -p vltxstakenow@active
...
echo "|____________________________________________________________________________________________________________________________________________|"
cleos --url  http://140.82.56.143:8888 set account permission vltxstakenow active vltxstakenow --add-code
...
echo "|____________________________________________________________________________________________________________________________________________|"
#cleos --url  http://140.82.56.143:8888 push action vltxstakenow initglobal '{}' -p vltxstakenow@active
#cleos --url  http://140.82.56.143:8888 push action volentixtsys transfer '{"from":"v11111111111", "to":"vltxstakenow", "quantity":"10000.00000000 VTX", "memo":"1"}' -p v11111111111@active
#cleos --url  http://140.82.56.143:8888 push action volentixtsys transfer '{"from":"v22222222222", "to":"vltxstakenow", "quantity":"10000.00000000 VTX", "memo":"1"}' -p v22222222222@active
#cleos --url  http://140.82.56.143:8888 push action volentixtsys transfer '{"from":"v33333333333", "to":"vltxstakenow", "quantity":"10000.00000000 VTX", "memo":"1"}' -p v33333333333@active
cleos --url  http://140.82.56.143:8888 get table vltxstakenow v11111111111 
#exit 1
...
#cleos --url  http://140.82.56.143:8888 push action volentixvote activateprod '{"producer":"v222222222222"}'-p v22222222222@active
#cleos --url  http://140.82.56.143:8888 push action volentixvote activateprod '{"producer":"v333333333333"}'-p v33333333333@active
...
#cleos --url  http://140.82.56.143:8888 push action vistribution setrewardrule '{"rule":{"reward_id":"1","reward_period":"100","reward_amount":"10.00000000 VTX","standby_amount":"2.00000000 VTX","rank_threshold":"10","standby_rank_threshold":"0", "memo":"Voting","standby_memo":"Voting"}}' -p vistribution@active
#cleos --url  http://140.82.56.143:8888 push action vistribution setrewardrule '{"rule":{"reward_id":"2","reward_period":"100","reward_amount":"66.00000000 VTX","standby_amount":"2.00000000 VTX","rank_threshold":"10","standby_rank_threshold":"0", "memo":"Oracle","standby_memo":"Oracle"}}' -p vistribution@active
#cleos --url  http://140.82.56.143:8888 get table vistribution vistribution rewards

cleos --url  http://140.82.56.143:8888 get table volentixvote volentixvote producers
...
node ../oracle/bridge_oracle_backup.js& 2> /dev/pts/1& 
#node vote_oracle2.js 2> /dev/pts/1& 
exit 1
#node vote_oracle2.js & 
#n=1
#while [ $n -le 5 ]
#do
#   echo "let period go by"
  ...
  echo "$PAYLOAD"
     ...
     PAYLOAD=$(echo "$PAYLOAD" | sed "s/$MATCH/$WORD/g")
     echo "$PAYLOAD"
     cleos --url  http://140.82.56.143:8888 push action vistribution uptime $PAYLOAD -p v22222222222@active
     ...
     cleos --url  http://140.82.56.143:8888 get currency balance volentixtsys v22222222222
     echo "v33333333333 balance_____________________"
     cleos --url  http://140.82.56.143:8888 get currency balance volentixtsys v33333333333
     i=$[$i+1]
      echo "uptimes__________________________________"
      cleos --url  http://140.82.56.143:8888 get table vistribution vistribution uptimes
      ...
      cleos --url  http://140.82.56.143:8888 get table volentixvote volentixvote voters
      echo "dht___________________________________"
      cleos --url  http://140.82.56.143:8888 get table vistribution vistribution dht
      echo "inituptime___________________________________" 
      cleos --url  http://140.82.56.143:8888 get table vistribution vistribution inituptime
