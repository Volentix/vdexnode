...
#define OPENDHT_INDEXATION 1

/* Define if DHT logs are enabled */
...
#define PACKAGE_NAME "opendht"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "opendht 1.9.4"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "opendht"
