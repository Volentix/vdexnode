...
cleos --url  http://140.82.56.143:8888 push action vistribution setrewardrule '{"rule":{"reward_id":"1","reward_period":"10","reward_amount":"10.00000000 VTX","standby_amount":"2.00000000 VTX","rank_threshold":"2","standby_rank_threshold":"10", "memo":"","standby_memo":""}}' -p vistribution@active
cleos --url  http://140.82.56.143:8888 push action vistribution setrewardrule '{"rule":{"reward_id":"2","reward_period":"10","reward_amount":"66.00000000 VTX","standby_amount":"2.00000000 VTX","rank_threshold":"2","standby_rank_threshold":"10", "memo":"","standby_memo":""}}' -p vistribution@active
n=1
...
do
    ...
    PAYLOAD='{"account":"v11111111111","job_ids":[1],"node_id":1,"memo":"1"}'
